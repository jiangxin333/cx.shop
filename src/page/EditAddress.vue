<template>
	<div class="">
		...
		<div class="row_box">
			<label>详细地址</label>
			<input type="text" v-model="detalAddress" />
			<!--<img src="../assets/btn_28_next.png" class="next_icon"/>-->
		</div>
...
<script>
	export default{
		...
		methods:{
			saveBtn(){
				var _this=this
				var url=_this.$store.state.urlConfig.modifyCustomerAddress
				var thisData={
					'intId':_this.intId,
					'eumIsdefault':_this.defaultAddress ? 0 : 1,
					'strAddress':_this.cityTxt_1+_this.cityTxt_2+_this.cityTxt_3+_this.cityTxt_4+_this.detalAddress,
		...
		created(){
			var _this=this
			var itemData=_this.$route.query.item
			console.log(itemData)
			_this.intId=itemData.intId
			_this.name=itemData.strName
			_this.phone=itemData.strContact
			_this.cityTxt_1=itemData.strProName
			_this.cityTxt_2=itemData.strCiName
			_this.cityTxt_3=itemData.strCouName
			_this.cityTxt_4=itemData.strStreetName
			_this.detalAddress=itemData.strStreetName
